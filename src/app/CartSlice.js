...
export const {setCloseCart, setOpenCart, setAddItemToCart, setGetTotals, setRemoveItemFromCart, setDecreaseItemQTY, setIncreaseItemQTY, setDeleteAll} = CartSlice.actions
