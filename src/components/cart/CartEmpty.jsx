...
const CartEmpty = ({onCartToggle}) => {
    return (
        ...
        flex-col h-screen px-11 text-center gap-7'>
            ...
            alt='emptybag/img' 
            src={emptybag} 
            className='w-40 lg:w-36 sm:2-28 h-auto object-fill 
            transition-all duration-300 hover:scale-110'/>
            <button type='button' className='button-theme 
            bg-gradient-to-b from-amber-500 to-orange-500 shadow-lg 
            shadow-orange-500 flex items-center justify-center 
            text-slate-900 py-2 gap-3 text-sm px-5 font-semibold 
