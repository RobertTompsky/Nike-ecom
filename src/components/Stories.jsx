                    ...
                    <Splide options={splideOptions}>
                        {news.map((val, i)=> (
                            <SplideSlide key={i} className='mb-0.5'>
                                <div className='grid items-center gap-4 pb-2 
                                rounded-lg shadow-slate-200 ring-1 
                                ring-slate-200'>
                                    <div className='flex items-center justify-items-center'>
                                        <img 
                                        src={val.img} 
                                        alt={`img/story/${i}`}
                                        className='w-full h-auto object-cover shadow-md shadow-slate-200 rounded-tl0lg rounded-tr-lg'
                                        />
                                    </div>
                                    ...
                                    <div className='grid items-center justify-items-start px-4'>
                                        ...
                                        <p className='text-sm text-justify lg:text-xs'>{truncate(val.text, {length: 160})}</p>
                                    </div>
                                    <div className='flex items-center justify-center px-4 w-full'>
                                        <a className='w-full bg-gradient-to-b from-slate-900 
                                        to-black shadow-md shadow-black text-center 
                                        text-slate-100 py-1.5 button-theme' href={val.url}
