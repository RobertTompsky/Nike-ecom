...
function Hero({heroapi: {title, subtitle, btntext, img, sociallinks, videos }}) {
    return (
        <div>
            <div className='relative h-auto w-auto flex flex-col'></div>
                <div 
                    className='bg-theme clip-path h-[85vh] lg:h-[75vh] 
                    md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 left-0 
                    right-0 opacity-100 z-10'></div>
                <div 
                    className='relative opacity-100 z-20 
                    ...
                    <div 
                        ...
                        <button 
                            ...
                            shadow-slate-200 rounded-xl font-semibold
                            my-5'>{btntext}</button>
                        <div 
                            className='grid items-center gap-5 md:gap-3 
                            absolute top-[33vh] lg:top-[27vh] left-[11%] 
